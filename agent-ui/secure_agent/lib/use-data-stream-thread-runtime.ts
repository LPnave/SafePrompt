...
export type UseDataStreamThreadRuntimeOptions = {
  api: string;
...
class DataStreamRuntimeAdapter implements ChatModelAdapter {
  constructor(
    private options: Omit<
      UseDataStreamThreadRuntimeOptions,
...
/**
 * Per-thread data stream runtime for use inside unstable_useRemoteThreadListRuntime.
 * Unlike useDataStreamRuntime, this uses useLocalThreadRuntime and does not nest
 * another remote thread list.
 */
export function useDataStreamThreadRuntime(
  options: UseDataStreamThreadRuntimeOptions,
) {
